...
class GpxConnection:public QGraphicsPathItem {
 public:
	enum { Type = UserType + GPXCONNECTION_TYPE };

	 GpxConnection(QPointF initPoint, QPointF endPoint,
		       GpxConnectionPoint * p = 0, QGraphicsItem * parent =
	...
	GpxConnectionPoint *getInitPort() {
		return myInitPort;
	};
